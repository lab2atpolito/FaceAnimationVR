...
obA = bpy.data.objects["Otto_1"]
KeyNameA = obA.data.shape_keys.name
shapekey_array_A = obA.data.shape_keys.key_blocks

obB = bpy.data.objects["Otto_2"]
KeyNameB = obB.data.shape_keys.name
shapekey_array_B = obB.data.shape_keys.key_blocks

shape_A_0 = "Mouth_cornerUp.L"
shape_B_0 = "Mouth_cornerUp.L"
shape_A_1 = "Mouth_cornerUp.R"
shape_B_1 = "Mouth_cornerUp.R"
shape_A_2 = "Eyebrow_surprise.L"
shape_B_2 = "Eyebrow_surprise.L"
shape_A_3 = "Eyebrow_surprise.R"
shape_B_3 = "Eyebrow_surprise.R"
...
def runtime():
    ...
    file = open(directory+"/weight_B.csv","a")
    
    row = "FRAME" + ";" + shape_A_0 + ";" + shape_B_0 + ";" + shape_A_1 + ";" + shape_B_1 +  ";" + shape_A_2 + ";" + shape_B_2 + ";" + shape_A_3 + ";" + shape_B_3 + ";\n"
    file.write(row)
    ...
    while(i<=END_FRAME):
        ...
        value_A_2 = shapekey_array_A[shape_A_2].value
        value_B_2 = shapekey_array_B[shape_B_2].value
        value_A_3 = shapekey_array_A[shape_A_3].value
        value_B_3 = shapekey_array_B[shape_B_3].value
        ...
        s5 = str("{0:.8f}".format(value_A_2).replace(".",","))
        s6 = str("{0:.8f}".format(value_B_2).replace(".",","))
        s7 = str("{0:.8f}".format(value_A_3).replace(".",","))
        s8 = str("{0:.8f}".format(value_B_3).replace(".",","))
        
        row = str(i) + ";" + s1 + ";" + s2 + ";" + s3 + ";" + s4 + ";" + s5 + ";" + s6 + ";" + s7 + ";" + s8 + ";\n"
        file.write(row)
